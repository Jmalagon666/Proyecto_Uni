    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #017bfe">
                <h5 class="modal-title" id="agregarRolModalLabel">Agregar Nuevo Rol</h5>
            ...
            <form action="{{ route('roles.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Ingrese el nombre del rol" required>
                    </div>
                </div>
